...
Starter project to easily bootstrap a React app served up with Express. Uses [custom-react-scripts](https://github.com/kitze/custom-react-scripts) to add support for ES6 decorators, SASS/SCSS, LESS, Stylus, & CSS modules without needing to eject out of Create React App.
